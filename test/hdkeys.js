...
var HDPrivateKey = telestaicore.HDPrivateKey;
var HDPublicKey = telestaicore.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = telestaicore.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(telestaicore.crypto.BN.prototype, 'toBuffer', function(args) {
      ...
      sandbox.spy(telestaicore.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      telestaicore.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = telestaicore.PublicKey.fromPoint;
      telestaicore.PublicKey.fromPoint = function() {
        telestaicore.PublicKey.fromPoint = unstubbed;
